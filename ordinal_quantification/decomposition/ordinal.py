"""
Generic quantifier based on Frank and Hall decomposition
"""
...
from ..base import BaseQuantifier, UsingClassifiers, WithoutClassifiers
from ..estimators.frank_and_hall import FrankAndHallClassifier
from ..estimators.utils import FHLabelBinarizer
from .utils import check_and_correct_prevalences_asc
...
class FrankAndHallQuantifier(UsingClassifiers):
    ...
    def predict(self, X, predictions_test=None):
        ...
        leftgroup_prevalences = check_and_correct_prevalences_asc(leftgroup_prevalences)
